...
public class RemoveColumns
  ...
  public String globalInfo() {
    return "Removes the specified columns.";
  }
  ...
  public String columnsTipText() {
    return "The columns to remove (comma-separated names).";
  }
  ...
  public Enumeration listOptions() {
    ...
    result.addElement(new Option("\tThe list of columns to remove\n"
  ...
  public Table processTable(Table table) {
    ...
    return (Table) table.removeColumns(columns);
  }
}
